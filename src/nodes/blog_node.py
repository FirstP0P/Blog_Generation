...
class BlogNode:
    ...
    def title_creation(self, state: BlogState):
        ...
        Generate a SEO-friendly blog title for: {state['topic']}
        """
    ...
    #         return {"blog": {"title": state['blog']['title'], "content": response.content}} # type: ignore
    ...
    def content_generation(self, state: BlogState):
        ...
        Generate detailed blog content for: {state['topic']}
        """
    ...
    #     blog_content=state["blog"]["content"] # type: ignore
    #     messages=[
    ...
    def translation(self, state: BlogState):
        prompt = f"""
        Translate this into {state['current_language']}:
